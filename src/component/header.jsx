...
export default function Header(){
    ...
    return (
        <div className="sticky top-0 z-50 bg-neutral-900 text-neutral-200 border-b border-neutral-800 ">
            <div className="mx-auto max-w-screen-xl px-4 md:px-6 lg:px-8 h-10 flex items-center justify-between ">
                <div className="flex items-center gap-3 text-[10px] md:text-sm">
